/**
 * @file SignUp.jsx
 * @description User Registration Component for Foodie-Frenzy App.
 * Handles user signup, input validation, token storage, and redirecting to orders.
 * Includes an integrated Login modal for returning users.
 */
...
/**
 * SignUp Component
 * @returns {JSX.Element} Signup form UI with validation and backend API integration.
 */
export default function SignUp() {
  ...
  /**
   * Submits user signup data to backend
